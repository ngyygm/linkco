...
linkco_path = os.path.abspath(__file__).replace('main.py', '').replace('\\', '/').replace('/c', '/')

print('【linkco_path】', linkco_path)
...
headers_list = [{'user-agent': 'Mozilla/5.0 (iPhone; CPU iPhone OS 13_2_3 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/13.0.3 Mobile/15E148 Safari/604.1'},
